...
table(crab.table$Sex, crab.table$Species) %>% kable(caption = "The Sex of Crabs by Species") %>% kable_styling()

table(crab.table$Sex, crab.table$BDGroup) %>% kable(caption = "The Sex of Crabs by Body Depth") %>% kable_styling()
...
The barplots below are visual depictions of the contingency tables.
